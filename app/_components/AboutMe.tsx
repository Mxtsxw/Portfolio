...
export default function AboutMe() {
    return (
        ...
        <div className="mt-4 md:mt-0 md:ml-4 w-full md:w-1/2 text-gray-400">
          ...
          <p className="mt-2">
          I am deeply interested in exploring how AI can make a difference in security and healthcare. Whether it is improving decision-making systems or tackling complex data problems, I am drawn to projects where technology meets <span className="text-white font-bold">critical impact</span>.
          </p>
          <p className="mt-2">
          Outside of tech, I have spent four years competing in <span className="text-white font-bold">volleyball</span>, developing resilience and teamwork. I also have a passion for <span className="text-white font-bold">filmmaking</span>. Both pursuits reflect my drive for growth and exploration across diverse fields.
          </p>
        </div>
      </div>
        </section>
